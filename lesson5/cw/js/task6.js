...
// 			doCoffee(10)    => "Приготовлено чашек кофе: 2, ;
...
function doCoffee(beansCount) {
    ...
    var emountOfCups =  Math.floor(beansCount / 5);
        console.log("Приготовлено чашек кофе: " + emountOfCups + ", осталось зерен: " + (beansCount - emountOfCups * 5));
        return;
}
