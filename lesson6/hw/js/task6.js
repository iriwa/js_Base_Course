...
// var films = watchList.map(watchList => ({
//     title: watchList.Title,
//     imdbRating: watchList.imdbRating
//   }));
  
// var filtered2 = films.filter(function (films) {
//     return (films.imdbRating >= 8.0);
// });

// console.log(filtered2);


var christophersFilms = watchList.filter(film => film.Director === "Christopher Nolan");

var AverageRating = christophersFilms.reduce(function (accumulator, current) {
    return accumulator + Number(current.imdbRating);
}, 0) / christophersFilms.length;
    console.log(AverageRating);


// var CNFilms = watchList.reduce(function (Director, imdbRating) {
//     return watchList.Director + watchList.imdbRating;
// }, 0) / watchList.length;
// console.log(CNFilms);